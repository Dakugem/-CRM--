...
- **КТП (Комплекс Технической Поддержки)**: Обработка инцидентов и заявок от абонентов.
- **WFM (Workforce Management)**: Управление персоналом на линиях (графики, смены, задачи для монтажников/инженеров).
...
- Реализовать авторизацию и ролевую модель:
  1. Админ
     ...
     - Доступ к модулю **Площадки заказчика**:
       1. Создание, удаление, резервирование площадки Заявителя/клиента
     - Доступ к модулю **Каталог**
       1. Создание, удаление, резервирование каталога Заявителя/клиента
       2. Создание, удаление, резервирование единицы оборудования с привязкой к площадке Заявителя/клиента
  2. Оператор КТП
